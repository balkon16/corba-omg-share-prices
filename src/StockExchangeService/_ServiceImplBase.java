                ...
                implements StockExchangeService.Service, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("getLastQuotation", new java.lang.Integer (1));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       case 0:  // StockExchangeService/Service/getAvailableStockExchanges
       {
         ...
         out = $rh.createReply();
         StockExchangeService.ServicePackage.stringSequenceHelper.write (out, $result);
         break;
       }

       case 1:  // StockExchangeService/Service/getLastQuotation
       {
         String ticker = in.read_string ();
         String stockExchange = in.read_string ();
         StockExchangeService.StockPrice $result = null;
         $result = this.getLastQuotation (ticker, stockExchange);
         out = $rh.createReply();
